...
> 版本: V1.6.5 · 快捷命令: `volss` · 支持 Debian / Ubuntu / Alpine
...
```
  ...
  V1.6.5  |  2026-07-18 12:47:08  |  volss
...
首页只显示分类，各分类内部重新从 `1` 连续编号。所有菜单统一使用大号 VOLSS 标题、`Shadowsocks-Rust 管理脚本` 副标题、实时日期、选项颜色、独立返回区和范围明确的输入提示；危险操作使用红色，暂停、重置等需谨慎操作使用黄色。
