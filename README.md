...
> 版本: V1.6.4 · 快捷命令: `volss` · 支持 Debian / Ubuntu / Alpine
...
首页只显示分类，各分类内部重新从 `1` 连续编号。所有菜单统一使用 VOLSS 标题栏、选项颜色、独立返回区和范围明确的输入提示；危险操作使用红色，暂停、重置等需谨慎操作使用黄色。
